...
clear
cd 
echo "\033[1;93m#ALHAMDULLAH"
figlet  "ALHAMDULLAH"
echo ""
apt update
apt upgrade
echo "$(tput setaf 5) Subscribe < B4 BALOCH M4 MASTER YT channel For more Termux videos "
echo ""
...
echo "|-----------------------------|"
echo "$(tput setaf 3) Subscribe B4 BALOCH M4 MASTER.."
echo "|-----------------------------|"
echo ""
